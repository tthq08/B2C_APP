...
class Pieces extends HomeBase
{
            ...
            if ($spec_list) {
                ...
                foreach ($spec_id as $key => $spec) {
                    ...
                    foreach ($item as $k => $v) {
                        ...
                        $item[$k]['href'] = url('shop/pieces/pieces_group',$url);
                    }
    ...
    public function pay()
    {
        ...
        if( empty(session('user.id')) ){
            $this->error(lang('cart_please_login'),url('shop/user/login'));
        }
    ...
    public function save_order()
    {
        ...
        $this->success('提交成功，将跳转到支付页面',url('shop/Pieces/do_pay',['id'=>$piecesData['id']]));
    }
