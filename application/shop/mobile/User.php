...
class User extends HomeBase
{
    ...
    public function edit_save()
    {
        ...
        switch ($type) {
            ...
            case 'store_name':
                ...
                $this->success('修改成功', 'shop/user/store_info');
                break;
    ...
    public function save_address()
    {
        ...
        if (empty(cookie('call_back'))) {
            $this->success(lang('user_save_success'), 'shop/user/address_list');
        }
    ...
    /*public function add_comment(){
        ...
        if( $order_goods['is_comment'] == 1 ){
            $this->error('该商品已经评论，无需重复评论','shop/user/order_list');
        }
    ...
    public function save_comment()
    {
        ...
        $this->success('评价成功', 'shop/user/order_list');
    }
    ...
    {
        session('user', null);
        return $this->success('会员注销成功', 'shop/user/login');
    }
        ...
        if (request()->isPost()) {
            ...
            if (!$bind_res) {
                ...
                if ($bind_ress !== false) {
                    ...
                    $this->success('用户绑定成功', url('shop/user/index'));
                } else {
