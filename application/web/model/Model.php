...
EOF;
        ...
        if ($data['type'] == 2) {
            ...
            $default = [
                'model'       => $data['id'],
                'level'       => '',
                'create_time' => request()-> NOW_TIME,
                'update_time' => request()-> NOW_TIME,
                'status'      => 1
            ];
            $data = [
                [
                ...
                [
                    'name'        => 'lang',
                    'title'       => '语言',
                    'define'      => 'int(3) UNSIGNED NOT NULL',
                    'type'        => 'linkage',
                    'show'        => 1,
                    'value'       => 1,
                    'ajax_url'    => 'Sys/Comm/ajaxGetLang',
                ],
                [
                    'name'        => 'model',
                    'title'       => '文档模型',
