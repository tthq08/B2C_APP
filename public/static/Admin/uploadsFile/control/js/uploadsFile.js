			...
			this.createCorePlug = function(){
				var params = {
					...
					onSuccess: function(file, response) {
						...
						$("#photo-container").append("<li id='"+para.pic_obj+"_"+file.index+"'><img src='"+$.parseJSON(response).url+"' /><input type='hidden' name='"+para.pic_obj+"["+file.index+"]' value='"+$.parseJSON(response).url+"' ><div class='file_bar '><divstyle='padding:5px;'><p class='file_name'>是否删除？</p><span class='file_del' data-index='0' title='删除'></span>   </div>  </div></li>");
